...
(() => {
  ...
  // output/Crypto.Subtle.Constants.AES/index.js
  var l256 = 256;
  var l192 = 192;
  var l128 = 128;
  var aesKW = "AES-KW";
  ...
  // output/Crypto.Subtle.Constants.EC/index.js
  var p521 = "P-521";
  var p384 = "P-384";
  var p256 = "P-256";
  var ecdsa = "ECDSA";
  ...
  // output/Crypto.Subtle.Constants.RSA/index.js
  var rsaPSS = "RSA-PSS";
  ...
  // output/Crypto.Subtle.Key.Types/foreign.js
  ...
  // output/Crypto.Subtle.Key.Types/index.js
  var bind2 = /* @__PURE__ */ bind(/* @__PURE__ */ bindExceptT(monadIdentity));
  ...
  var sign2 = "sign";
  var raw = "raw";
  var errorFromDOMException = function(x) {
    var v = runExcept(bind2(readProp2("message")(x))(readString2));
    if (v instanceof Left) {
      return error("Not a DOMException");
    }
    ;
    if (v instanceof Right) {
    ...
    ;
    throw new Error("Failed pattern match at Crypto.Subtle.Key.Types (line 136, column 27 - line 138, column 21): " + [v.constructor.name]);
  };
  var exportKey = function(f) {
    return function(x) {
      return toAff$prime(errorFromDOMException)(exportKeyImpl(f, x));
    };
  };
  var encrypt = "encrypt";
  ...
  var decrypt = "decrypt";
  var allUsages = [encrypt, decrypt, sign2, verify, deriveKey, deriveBits, wrapKey, unwrapKey];

  // output/Crypto.Subtle.Hash/index.js
  var sha512 = "SHA-512";
  var sha384 = "SHA-384";
  var sha256 = "SHA-256";
  var sha1 = "SHA-1";

  // output/Crypto.Subtle.Key.Generate/foreign.js
  function generateKeyImpl(a, e, u) {
    return crypto.subtle.generateKey(a, e, u);
  }
  var exp65537 = new Uint8Array([1, 0, 1]);

  // output/Crypto.Subtle.Key.Generate/index.js
  var rsa = function(r) {
    return function(l) {
      return function(e) {
        return function(h) {
  ...
  var generateKeyPair = function(a) {
    return function(e) {
      return function(u) {
        return toAff$prime(errorFromDOMException)(generateKeyImpl(a, e, u));
      };
    };
  };
  ...
  var log$prime = /* @__PURE__ */ function() {
    var $38 = liftEffect(monadEffectAff);
    return function($39) {
      return $38(log2($39));
    };
  }();
  var main = /* @__PURE__ */ function() {
    var resolve = function(eX) {
      if (eX instanceof Left) {
        return throwException(eX.value0);
      }
      ;
      if (eX instanceof Right) {
        return pure3(unit);
      }
      ;
      throw new Error("Failed pattern match at Test.Main (line 24, column 20 - line 26, column 29): " + [eX.constructor.name]);
    };
    return runAff_(resolve)(discard2(log$prime("Generating Keys..."))(function() {
      return discard2(function() {
        var genAES = function(mode) {
          return discard2(bind3(bindFlipped3(exportKey(raw))(generateKey(aes(mode)(l128))(true)(allUsages)))(function(k) {
            return discard2(log$prime("  - 128"))(function() {
              return log$prime(k);
            });
          }))(function() {
            return discard2(bind3(bindFlipped3(exportKey(raw))(generateKey(aes(mode)(l192))(true)(allUsages)))(function(k) {
              return discard2(log$prime("  - 192"))(function() {
                return log$prime(k);
              });
            }))(function() {
              return bind3(bindFlipped3(exportKey(raw))(generateKey(aes(mode)(l256))(true)(allUsages)))(function(k) {
                return discard2(log$prime("  - 256"))(function() {
                  return log$prime(k);
                });
              });
            });
        ...
        return discard2(log$prime("- AES-CTR"))(function() {
          return discard2(genAES(aesCTR))(function() {
            return discard2(log$prime("- AES-CBC"))(function() {
              return discard2(genAES(aesCBC))(function() {
                return discard2(log$prime("- AES-GCM"))(function() {
                  return discard2(genAES(aesGCM))(function() {
                    return discard2(log$prime("- AES-KW"))(function() {
                      return genAES(aesKW);
                    });
                  });
                });
        ...
        return discard2(discard2(log$prime("HMAC"))(function() {
          return discard2(bind3(bindFlipped3(exportKey(raw))(generateKey(hmac(sha1))(true)(allUsages)))(function(k) {
            return discard2(log$prime("  - SHA-1"))(function() {
              return log$prime(k);
            });
          }))(function() {
            return discard2(bind3(bindFlipped3(exportKey(raw))(generateKey(hmac(sha256))(true)(allUsages)))(function(k) {
              return discard2(log$prime("  - SHA-256"))(function() {
                return log$prime(k);
              });
            }))(function() {
              return discard2(bind3(bindFlipped3(exportKey(raw))(generateKey(hmac(sha384))(true)(allUsages)))(function(k) {
                return discard2(log$prime("  - SHA-384"))(function() {
                  return log$prime(k);
                });
              }))(function() {
                return bind3(bindFlipped3(exportKey(raw))(generateKey(hmac(sha512))(true)(allUsages)))(function(k) {
                  return discard2(log$prime("  - SHA-512"))(function() {
                    return log$prime(k);
                  });
                });
              });
          ...
          return discard2(function() {
            var genEC = function(alg) {
              return discard2(bind3(generateKeyPair(ec(alg)(p256))(true)(allUsages))(function(v) {
                return discard2(log$prime("  - P-256"))(function() {
                  return discard2(log$prime("    - privateKey"))(function() {
                    return discard2(log$prime(v.privateKey))(function() {
                      return discard2(log$prime("    - publicKey"))(function() {
                        return bind3(exportKey(raw)(v.publicKey))(function(publicKey$prime) {
                ...
                return discard2(bind3(generateKeyPair(ec(alg)(p384))(true)(allUsages))(function(v) {
                  return discard2(log$prime("  - P-384"))(function() {
                    return discard2(log$prime("    - privateKey"))(function() {
                      return discard2(log$prime(v.privateKey))(function() {
                        return discard2(log$prime("    - publicKey"))(function() {
                          return bind3(exportKey(raw)(v.publicKey))(function(publicKey$prime) {
                  ...
                  return bind3(generateKeyPair(ec(alg)(p521))(true)(allUsages))(function(v) {
                    return discard2(log$prime("  - P-521"))(function() {
                      return discard2(log$prime("    - privateKey"))(function() {
                        return discard2(log$prime(v.privateKey))(function() {
                          return discard2(log$prime("    - publicKey"))(function() {
                            return bind3(exportKey(raw)(v.publicKey))(function(publicKey$prime) {
            ...
            return discard2(log$prime("- ECDSA"))(function() {
              return discard2(genEC(ecdsa))(function() {
                return discard2(log$prime("- ECDH"))(function() {
                  return genEC(ecdh);
                });
              });
            });
            ...
            var genRSA = function(alg) {
              return discard2(bind3(generateKeyPair(rsa(alg)(2048)(exp65537)(sha1))(true)(allUsages))(function(v) {
                return discard2(log$prime("  - SHA-1"))(function() {
                  return discard2(log$prime("    - privateKey"))(function() {
                    return discard2(log$prime(v.privateKey))(function() {
                      return discard2(log$prime("    - publicKey"))(function() {
                ...
                return discard2(bind3(generateKeyPair(rsa(alg)(2048)(exp65537)(sha256))(true)(allUsages))(function(v) {
                  return discard2(log$prime("  - SHA-256"))(function() {
                    return discard2(log$prime("    - privateKey"))(function() {
                      return discard2(log$prime(v.privateKey))(function() {
                        return discard2(log$prime("    - publicKey"))(function() {
                  ...
                  return discard2(bind3(generateKeyPair(rsa(alg)(2048)(exp65537)(sha384))(true)(allUsages))(function(v) {
                    return discard2(log$prime("  - SHA-384"))(function() {
                      return discard2(log$prime("    - privateKey"))(function() {
                        return discard2(log$prime(v.privateKey))(function() {
                          return discard2(log$prime("    - publicKey"))(function() {
                    ...
                    return bind3(generateKeyPair(rsa(alg)(2048)(exp65537)(sha512))(true)(allUsages))(function(v) {
                      return discard2(log$prime("  - SHA-512"))(function() {
                        return discard2(log$prime("    - privateKey"))(function() {
                          return discard2(log$prime(v.privateKey))(function() {
                            return discard2(log$prime("    - publicKey"))(function() {
            ...
            return discard2(log$prime("- RSASSA-PKCS1-v1_5"))(function() {
              return discard2(genRSA(rsaPKCS1))(function() {
                return discard2(log$prime("- RSA-PSS"))(function() {
                  return discard2(genRSA(rsaPSS))(function() {
                    return discard2(log$prime("- RSA-OAEP"))(function() {
                      return genRSA(rsaOAEP);
                    });
                  });
                });
              });
